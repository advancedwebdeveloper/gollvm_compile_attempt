...
set(stdout_log "/media/ubuntu/RESERVE0/workspace/build.rel/tools/gollvm/external/install/src/libmpc-stamp/libmpc-install-out.log")
set(stderr_log "/media/ubuntu/RESERVE0/workspace/build.rel/tools/gollvm/external/install/src/libmpc-stamp/libmpc-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /media/ubuntu/RESERVE0/workspace/build.rel/tools/gollvm/external/install/src/libmpc-stamp/libmpc-install-*.log")
  endif()
  ...
  set(msg "libmpc install command succeeded.  See also /media/ubuntu/RESERVE0/workspace/build.rel/tools/gollvm/external/install/src/libmpc-stamp/libmpc-install-*.log")
  message(STATUS "${msg}")
endif()
