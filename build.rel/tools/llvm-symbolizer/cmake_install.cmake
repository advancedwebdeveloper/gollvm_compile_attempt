# Install script for directory: /media/ubuntu/RESERVE0/workspace/llvm-project/llvm/tools/llvm-symbolizer
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xllvm-symbolizerx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/media/ubuntu/RESERVE0/workspace/build.rel/bin/llvm-symbolizer")
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xllvm-addr2linex" OR NOT CMAKE_INSTALL_COMPONENT)
  include("/media/ubuntu/RESERVE0/workspace/llvm-project/llvm/cmake/modules/LLVMInstallSymlink.cmake")
endif()
